...
export const FrameStrip = () => {
  ...
  return (
    <Card className="p-2 border-t">
      ...
      <div className="w-full overflow-x-auto overflow-y-hidden whitespace-nowrap" style={{ maxHeight: '120px' }}>
        <div className="inline-flex gap-1.5 pb-1"  style={{ minWidth: 'max-content' }}>
